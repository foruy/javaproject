...
public class VpnProfile implements Serializable {
    ...
    public static final int TYPE_DAOLICLOUD = 10;
    public int mAuthenticationType = TYPE_DAOLICLOUD;
    public String mName;
    ...
    public void setServer(String name, String port) {
        mServerName = name;
        mServerPort = port;
    }
    ...
    public void setOptions(Map<String, String> map) {
        for(String key : map.keySet()) {
            options += insertFileData(key, INLINE_TAG + map.get(key));
        }
    }
    ...
    public VpnProfile(String uuid, String name) {
